...
export default function Finance() {
  ...
  async function handleSave() {
    ...
    try {
      if (editing) {
        await db.updateExpense({ ...editing, ...form });
      } else {
        await db.addExpense(form);
      }
      setModalOpen(false);
    } finally {
      setSaving(false);
  ...
  return (
    <div className="flex flex-col min-h-screen pb-nav">
            ...
            <div className="card">
              ...
              <ResponsiveContainer width="100%" height={180}>
                <BarChart data={chartData} barSize={12}>
                  ...
                  <YAxis hide />
                  <Tooltip formatter={(v: unknown) => formatCurrency(Number(v))} contentStyle={{ borderRadius: 12, border: 'none', fontSize: 11 }} />
      ...
      <ConfirmDialog
        ...
        onConfirm={async () => {
          if (toDelete) await db.deleteExpense(toDelete.id);
          setToDelete(null);
        }}
